                                ...
                                StreamBuilder<List<TasksRecord>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    return LinearPercentIndicator(
                                      percent: (int total, int complete) {
                                        return total > 0
                                            ? (complete / total)
                                            : 0.0;
                                      ...
                                      progressColor: Color(0xFFB869D1),
                                      backgroundColor:
                          ...
                          queryBuilder: (tasksRecord) => tasksRecord
                            ...
                            if (_model.listViewPreviousSnapshot1 != null &&
                                !const ListEquality(
                                    ...
                                    .equals(listViewTasksRecordList,
                                        _model.listViewPreviousSnapshot1)) {
                              () async {}();
                            }
                            _model.listViewPreviousSnapshot1 = snapshot;
                          }),
                        builder: (context, snapshot) {
                          // Customize what your widget looks like when it's loading.
                          if (!snapshot.hasData) {
                      ...
                      child: StreamBuilder<List<TasksRecord>>(
                        stream: queryTasksRecord(
                          queryBuilder: (tasksRecord) => tasksRecord
                            ...
                            List<TasksRecord> listViewTasksRecordList =
                                snapshot;
                            if (_model.listViewPreviousSnapshot2 != null &&
                                !const ListEquality(
                                        TasksRecordDocumentEquality())
                                    .equals(listViewTasksRecordList,
                            ...
                            _model.listViewPreviousSnapshot2 = snapshot;
                          }),
                        builder: (context, snapshot) {
                          // Customize what your widget looks like when it's loading.
                          if (!snapshot.hasData) {
